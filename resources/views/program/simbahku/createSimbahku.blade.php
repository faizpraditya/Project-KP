                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Tambah Data Penerima SIMBAHKU</li>
                        </ol>
                    </div>
                    <div class="col-sm-6">
                    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="mt-0 header-title">Tambah Data Penerima SIMBAHKU</h4>
                            <p class="text-muted mb-4">Isi data penerima SIMBAHKU baru pada form dibawah ini dengan lengkap.</p>

                            <form method="POST" class="custom-validation" action="/simbahku">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Nama</label>
                                            <input name="nama" type="text" class="form-control" required placeholder="Nama penerima SIMBAHKU"/>
                                        </div>
                                        <div class="form-group">
