                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" class="custom-validation" action="/penyaluran">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Program</label>
                                            <input value="Program Lain" name="program" type="text" class="form-control" required placeholder="Nama program" hidden/>
                                            <input value="Program Lain" name="program" type="text" class="form-control" required placeholder="Nama program" disabled/>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Tanggal</label>
                                            <input name="tgl_penyaluran" class="form-control" type="date" id="example-date-input" value="<?= date('Y-m-d') ?>">
                                        </div>
                                        <div class="form-group">
