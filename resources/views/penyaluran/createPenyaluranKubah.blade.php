                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Program</label>
                                            <input value="KUBAH" name="program" type="text" class="form-control" required placeholder="Nama program" hidden/>
                                            <input value="KUBAH" name="program" type="text" class="form-control" required placeholder="Nama program" disabled/>
                                        </div>
                                        <div class="form-group">
